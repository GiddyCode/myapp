      ...
      body: ListView(
        children: [
          SwitchListTile(
            ...
            subtitle: const Text('Activate SOS without any sound or notification'),
            value: false,
            onChanged: (value) {
          ...
          SwitchListTile(
            ...
            subtitle: const Text('Automatically share your live location with trusted contacts during an SOS'),
            value: true,
            onChanged: (value) {
              // TODO: Implement setting change
            },
          ...
          ListTile(
            ...
            subtitle: const Text('Personalize the message sent to your trusted contacts'),
